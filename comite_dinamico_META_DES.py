...
wb = load_workbook('teste metades.xlsx')

ws = wb['KNORA-U']
'''
wb = load_workbook('meta_des.xlsx')
ws = wb['meta_des']
...
class MyKnoraE(METADES):
    ...
    def _dynamic_weighting(self, competences, predictions, probabilities):        
        ...
        print("EXECUXAO DE "+self.voting_type)
...
for vizinhos_no_teste in v_total_teste:
    ...
    #for melhor_k in [11]:
        ...
        total_execucoes = 1#VALIDAÇÔES EXECUCOES
        for iii in range(total_execucoes):
            ...
            #ECOLI
            qualidade = pd.read_csv("bases/ecoli.data")
            qualidade = qualidade.drop('name',axis=1) 
            #print(qualidade)
            ...
            ''''           
            qualidade = pd.read_csv("bases/seismic.csv")
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('class',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('class',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.columns[:-1])
            ...
            '''
            qualidade = pd.read_csv("bases/insuficiencia.csv")
            #print(qualidade)
            
            qualidade = qualidade.drop('Age',axis=1)
            ...
            '''
            #GLASS
            qualidade = pd.read_csv("bases/glass.data")
            ...
            '''
            #SONAR
            qualidade = pd.read_csv("bases/sonar.all-data", header=None, prefix='col_')
            #qualidade = qualidade.drop('col_0',axis=1) 
            #print(qualidade)

            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('col_60',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('col_60',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('col_60',axis=1).columns )
            X = df_feat
            y = qualidade['col_60']
            '''
            ...
            '''
            #SEMEION
            qualidade = pd.read_csv("bases/semeion.data", header=None, prefix='col_', sep=' ')
            #qualidade = qualidade.drop('col_0',axis=1) 
            #print(qualidade)

            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('col_256',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('col_256',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('col_256',axis=1).columns )
            X = df_feat
            y = qualidade['col_256']
            '''
            ...
            '''
            #HEATR
            qualidade = pd.read_csv("bases/heart.csv")
            #print(qualidade)
            #qualidade = qualidade.drop('name',axis=1) 
            ...
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('output',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('output',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('output',axis=1).columns )
            X = df_feat
            y = qualidade['output']
            ...
            '''
            #Audiology
            qualidade = pd.read_csv("bases/audiology.data", header=None, prefix='col_')
            ...
            median_col = qualidade.col_7.median()
            qualidade.col_7.fillna(median_col, inplace=True)
            median_col = qualidade.col_5.median()
            qualidade.col_5.fillna(median_col, inplace=True)
            median_col = qualidade.col_63.median()
            qualidade.col_63.fillna(median_col, inplace=True)
            median_col = qualidade.col_58.median()
            qualidade.col_58.fillna(median_col, inplace=True)
            median_col = qualidade.col_3.median()
            qualidade.col_3.fillna(median_col, inplace=True)
            median_col = qualidade.col_4.median()
            qualidade.col_4.fillna(median_col, inplace=True)
            median_col = qualidade.col_59.median()
            qualidade.col_59.fillna(median_col, inplace=True)
            #print(median_col)
            #print(qualidade.isnull().sum().sort_values(ascending=False))
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('col_70',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('col_70',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('col_70',axis=1).columns )
            X = df_feat
            y = qualidade['col_70']
            '''
            ...
            '''
            #Hepatitis
            qualidade = pd.read_csv("bases/hepatitis.data")
            #qualidade = qualidade.drop('col_69',axis=1) 
            #print(qualidade)
            #print("Nulos")
            #print(qualidade.isnull().sum().sort_values(ascending=False))

            median_col = qualidade.PROTIME.median()
            qualidade.PROTIME.fillna(median_col, inplace=True)
            median_col = qualidade.ALK_PHOSPHATE.median()
            qualidade.ALK_PHOSPHATE.fillna(median_col, inplace=True)
            median_col = qualidade.ALBUMIN.median()
            qualidade.ALBUMIN.fillna(median_col, inplace=True)
            median_col = qualidade.LIVER_FIRM.median()
            qualidade.LIVER_FIRM.fillna(median_col, inplace=True)
            median_col = qualidade.LIVER_BIG.median()
            qualidade.LIVER_BIG.fillna(median_col, inplace=True)
            median_col = qualidade.BILIRUBIN.median()
            qualidade.BILIRUBIN.fillna(median_col, inplace=True)
            median_col = qualidade.SPLEEN_PALPABLE.median()
            qualidade.SPLEEN_PALPABLE.fillna(median_col, inplace=True)
            median_col = qualidade.SPIDERS.median()
            qualidade.SPIDERS.fillna(median_col, inplace=True)
            median_col = qualidade.ASCITES.median()
            qualidade.ASCITES.fillna(median_col, inplace=True)
            median_col = qualidade.VARICES.median()
            qualidade.VARICES.fillna(median_col, inplace=True)
            median_col = qualidade.SGOT.median()
            qualidade.SGOT.fillna(median_col, inplace=True)
            median_col = qualidade.STEROID.median()
            qualidade.STEROID.fillna(median_col, inplace=True)
            median_col = qualidade.FATIGUE.median()
            qualidade.FATIGUE.fillna(median_col, inplace=True)
            median_col = qualidade.MALAISE.median()
            qualidade.MALAISE.fillna(median_col, inplace=True)
            median_col = qualidade.ANOREXIA.median()
            qualidade.ANOREXIA.fillna(median_col, inplace=True)            
            ...
            '''
            #PARKINSONS
            qualidade = pd.read_csv("bases/parkinsons.data")
            #print(qualidade)
            qualidade = qualidade.drop('name',axis=1) 
            ...
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('status',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('status',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('status',axis=1).columns )
            X = df_feat
            y = qualidade['status']
            '''
            ...
            '''
            #ARRHYTHMIA
            qualidade = pd.read_csv("bases/arrhythmia.data", header=None, prefix='col_')
            #qualidade = qualidade.drop('col_69',axis=1) 
            #print(qualidade)
            #print("Nulos")
            #print(qualidade.isnull().sum().sort_values(ascending=False))
            ...
            median_col = qualidade.col_13.median()
            qualidade.col_13.fillna(median_col, inplace=True)
            median_col = qualidade.col_11.median()
            qualidade.col_11.fillna(median_col, inplace=True)
            median_col = qualidade.col_10.median()
            qualidade.col_10.fillna(median_col, inplace=True)
            median_col = qualidade.col_12.median()
            qualidade.col_12.fillna(median_col, inplace=True)
            median_col = qualidade.col_14.median()
            qualidade.col_14.fillna(median_col, inplace=True)       
            #print(median_col) 
            #print(qualidade.isnull().sum().sort_values(ascending=False))
            
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('col_279',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('col_279',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('col_279',axis=1).columns )
            X = df_feat
            y = qualidade['col_279']
            '''
            ...
            '''
            #Hill Valley
            qualidade = pd.read_csv("bases/Hill_Valley_without_noise_Training.data")
            #print(qualidade)
            #qualidade = qualidade.drop('name',axis=1) 
            ...
            '''
            #PIMA DIABETES
            qualidade = pd.read_csv("bases/pima_diabetes.csv")
            #print(qualidade)
            #qualidade = qualidade.drop('name',axis=1) 
            ...
            scaler.fit(qualidade.drop('Outcome',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('Outcome',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('Outcome',axis=1).columns )
            X = df_feat
            y = qualidade['Outcome']
            ...
            '''
            #Absenteeism_at_work
            qualidade = pd.read_csv("bases/Absenteeism_at_work.csv")
            #qualidade = qualidade.drop('col_69',axis=1) 
            #print(qualidade)
            #print("Nulos")
            #print(qualidade.isnull().sum().sort_values(ascending=False))
            ...
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('Absenteeism time in hours',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('Absenteeism time in hours',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('Absenteeism time in hours',axis=1).columns )
            X = df_feat
            y = qualidade['Absenteeism time in hours']
            #print(X)
            #print(y)
            '''
            ...
            qualidade = pd.read_csv("bases/bone-marrow.csv")
            #print(qualidade)
            #qualidade = qualidade.drop('Case #',axis=1) 
            #print(qualidade)
            median_col = qualidade.extcGvHD.median()
            qualidade.extcGvHD.fillna(median_col, inplace=True)
            median_col = qualidade.CMVstatus.median()
            qualidade.CMVstatus.fillna(median_col, inplace=True)
            median_col = qualidade.RecipientCMV.median()
            qualidade.RecipientCMV.fillna(median_col, inplace=True)
            median_col = qualidade.CD3dkgx10d8.median()
            qualidade.CD3dkgx10d8.fillna(median_col, inplace=True)
            
            median_col = qualidade.CD3dCD34.median()
            qualidade.CD3dCD34.fillna(median_col, inplace=True)
            median_col = qualidade.DonorCMV.median()
            qualidade.DonorCMV.fillna(median_col, inplace=True)
            
            median_col = qualidade.Rbodymass.median()
            qualidade.Rbodymass.fillna(median_col, inplace=True)
            median_col = qualidade.RecipientRh.median()
            qualidade.RecipientRh.fillna(median_col, inplace=True)
            median_col = qualidade.Alel.median()
            qualidade.Alel.fillna(median_col, inplace=True)
            
            median_col = qualidade.Antigen.median()
            qualidade.Antigen.fillna(median_col, inplace=True)
            median_col = qualidade.RecipientABO.median()
            qualidade.RecipientABO.fillna(median_col, inplace=True)
            median_col = qualidade.ABOmatch.median()
            qualidade.ABOmatch.fillna(median_col, inplace=True)
            
            #print("Nulos")
            #print(qualidade.isnull().sum().sort_values(ascending=False))
            
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('survival_status',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('survival_status',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('survival_status',axis=1).columns )
            X = df_feat
            y = qualidade['survival_status']
            #print(X)
            #print(y)
            '''
            ...
            '''    
            #Risk Factors Cervical Cancer  https://archive.ics.uci.edu/ml/datasets/Cervical+cancer+%28Risk+Factors%29
            ...
            qualidade = pd.read_csv("bases/phishing_websites.csv")
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('Result',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('Result',axis=1))#normaliza por media edesvio padrão
            df_feat = pd.DataFrame(scaled_features,columns=qualidade.drop('Result',axis=1).columns )
            X = df_feat
            y = qualidade['Result']
            '''
            ...
            qualidade = pd.read_csv("bases/yeast.data")
            qualidade = qualidade.drop('name',axis=1)
            scaler = StandardScaler() # inicializar
            scaler.fit(qualidade.drop('class',axis=1))#treinar o modelo de normalização para padronizar,
            scaled_features = scaler.transform(qualidade.drop('class',axis=1))#normaliza por media edesvio padrão
            ...
            inc = 0
            #while( len(np.unique(y_train, return_counts=False)) < len(np.unique(y, return_counts=False)) ):
            ...
            pool_classifiers = BaggingClassifier(Perceptron(max_iter=10), n_estimators=100, random_state=rng)
            pool_classifiers.fit(X_train, y_train)
            ...
            meta = MyKnoraE(calibrated_pool)
            


            print("train")
            meta.fit(X_test, y_test)
