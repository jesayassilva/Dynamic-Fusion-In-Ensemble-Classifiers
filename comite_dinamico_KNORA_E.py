...
#coluna_valor = 20
#coluna_desvio_padrao = 21

coluna_valor = 2
coluna_desvio_padrao = 3

wb = load_workbook('KnoraE 30 bases.xlsx')
...
for vizinhos_no_teste in v_total_teste:
    ...
    #for melhor_k in [11]:
        ...
        total_execucoes = 4#VALIDAÇÔES EXECUCOES
